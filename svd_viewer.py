...
type_to_pseudo_attributes = {
	...
	"register": ["name", "displayName", "addressOffset", "size", "dim", "dimIncrement", "dimIndex", "dimName", "dimArrayIndex", "access", "resetValue", "resetMask", "alternateRegister", "description"],
